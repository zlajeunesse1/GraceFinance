"""
Debts Router — FIXED: UUID path parameters (was int, would crash on UUID PKs)
"""
...
def list_debts(
    ...
    for debt in debts:
        ...
        if debt.credit_limit and debt.credit_limit > 0:
            resp.utilization = round(float(debt.balance) / float(debt.credit_limit) * 100, 1)
        result.append(resp)
