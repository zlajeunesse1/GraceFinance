      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '48px' }}>
        <div style={{ width: '100%', maxWidth: 380 }}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ textAlign: 'right', marginBottom: 32 }}><Link to="/forgot-password" style={{ fontSize: 12, color: '#6b7280', textDecoration: 'none' }}>Forgot password?</Link></div>
          ...
          <p style={{ textAlign: 'center', marginTop: 32, fontSize: 13, color: '#6b7280' }}>New here?{' '}<Link to="/signup" style={{ color: '#ffffff', fontWeight: 500, textDecoration: 'none' }}>Create your account</Link></p>
        </div>
      </div>
    </div>
  )
